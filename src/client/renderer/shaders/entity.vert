...
// Binding 2: Entity/Model Constants
...
layout(location = 3) in vec2 inLightmapUV; // unused for entity right now, added for packing
...
void main() {
    vec4 pos = u_model.model * vec4(inPosition, 1.0);
