...
bool Entity::load( CompoundTag* tag )
{
    ...
    xx = Mth::clamp(xx, -(float)Level::MAX_LEVEL_SIZE + padding, (float)Level::MAX_LEVEL_SIZE - padding);
    zz = Mth::clamp(zz, -(float)Level::MAX_LEVEL_SIZE + padding, (float)Level::MAX_LEVEL_SIZE - padding);
